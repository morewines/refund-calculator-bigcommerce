      ...
      <table>
        <thead>
          <tr>
            ...
            <th className="order-table-center edit-table-header table-currency">
              Price
            </th>
            <th className="order-table-center edit-table-total table-currency">
              Total
            </th>
          </tr>
        </thead>
          ...
          <tr>
            ...
            <td className="order-table-center">
              <div className="clearfix">
                ...
                <span className="float-right">{editSubTotal}</span>
              </div>
              <div className="clearfix">
                <span className="float-left order-dollar order-price">$</span>
                <span className="float-right">{editCouponTotal}</span>
              </div>
              <div className="clearfix">
                <span className="float-left order-dollar order-price">$</span>
              ...
              <div className="clearfix">
                <span className="float-left order-dollar order-price">$</span>
                <span className="float-right">{editSalesTax}</span>
              </div>
              <div className="clearfix">
              ...
              <div className="clearfix order-total">
                <div className="float-left order-dollar order-price">
                  <b>$</b>
                </div>
                <span className="float-right">
                  <b>{editGrandTotal}</b>
