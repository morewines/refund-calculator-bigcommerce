    ...
    <div className="add-substitute-wrapper">
      ...
      <div className="row">
        <div className="column column-75">
          <form className="substitute-form" onSubmit={handleSubstituteSubmit}>
            ...
            <input
              ...
              type="text"
              placeholder="Ex: Pinnacle Mimosa Flavored Vodka 750ml"
              id="item-name"
              autoFocus
              required
            />
            ...
            <button
              className="button-primary button-mw button-space"
              type="submit"
            >
              <FaPlus
                size={18}
